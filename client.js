...
"use strict";require("earlgrey-runtime/5");var $targ$0 = undefined;var $it$6 = undefined;var $it$5 = undefined;var $it$1 = undefined;var $it$0 = undefined;var countryApp$0 = undefined;if (typeof angular === "undefined") {
  $targ$0 = undefined;global.angular = $targ$0;void 0;
}countryApp$0 = angular.module("countryApp", ["ngRoute"]);$it$0 = countryApp$0;$it$1 = $it$0.config(["$routeProvider", function ($routeProvider$0) {
  var $it$4 = undefined;var $it$3 = undefined;var $it$2 = undefined;var $targ$1 = undefined;$targ$1 = $routeProvider$0.when;$routeProvider$0.route = $targ$1;$it$2 = $routeProvider$0;$it$3 = $it$2.route("/", { templateUrl: "country-list.html", controller: "CountryListCtrl" });$it$4 = $it$3.route("/:countryName", { templateUrl: "country-detail.html", controller: "CountryDetailCtrl" });return $it$4.otherwise({ redirectTo: "/" });
}]);$it$5 = $it$1.factory("countries", ["$http", function ($http$0) {
  return { list: function list(cb$0) {
      return $http$0.get("countries.json").success(cb$0);
    }, find: function find(name$0, cb$1) {
      return $http$0.get("countries.json").success(function (data$0) {
        var country$0 = undefined;country$0 = data$0.filter(function (etr$0) {
          return etr$0.name === name$0;
        })[0];return cb$1(country$0);
      });
    } };
}]);$it$6 = $it$5.controller("CountryListCtrl", ["$scope", "countries", function ($scope$0, countries$0) {
  return countries$0.list(function (countries$1) {
    var $targ$2 = undefined;$targ$2 = countries$1;$scope$0.countries = $targ$2;return void 0;
  });
}]);$it$6.controller("CountryDetailCtrl", ["$scope", "$routeParams", "countries", function ($scope$1, $routeParams$0, countries$2) {
  return countries$2.find($routeParams$0.countryName, function (country$1) {
    var $targ$3 = undefined;$targ$3 = country$1;$scope$1.country = $targ$3;return void 0;
  });
}]);


}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"earlgrey-runtime/5":3}],3:[function(require,module,exports){
(function (global){
...
},{"./lib":4,"core-js/shim":5,"regenerator/runtime":6}],4:[function(require,module,exports){
(function (global){
